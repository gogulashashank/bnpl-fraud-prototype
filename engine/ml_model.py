...
def train_model():
    ...
    # Constrain the model to prevent 100% pure leaves. This ensures predict_proba outputs 
    # realistic confidence scores (e.g., 88%, 94%) instead of a fake-looking 100%.
    clf = RandomForestClassifier(n_estimators=100, max_depth=4, min_samples_leaf=5, random_state=42)
